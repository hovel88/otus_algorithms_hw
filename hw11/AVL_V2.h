...
public:
    virtual ~AVL_V2();
    AVL_V2() = default;
    AVL_V2(const AVL_V2&) = delete;
    AVL_V2(AVL_V2&&) = delete;
    AVL_V2& operator=(const AVL_V2&) = delete;
    AVL_V2& operator=(AVL_V2&&) = delete;

    std::string name() const override { return "AVL_V2"; }
