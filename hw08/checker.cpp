...
void increase_stack(uint32_t mb)
{
    const rlim_t stack_size = mb * 1024 * 1024;
    struct rlimit rl;
...
int main(int argc, char** argv)
{
    ...
    tested_algos.emplace_back(std::make_shared<QuickSort>(QuickSort::V1));
    tested_algos.emplace_back(std::make_shared<MergeSort>(MergeSort::V1));
