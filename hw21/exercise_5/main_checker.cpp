...
using func_under_test_t = std::function<std::string(const std::string& N_str, const std::string& M_str, const std::vector<std::string>& data)>;
                                   ...
                                   const std::vector<std::string>& input)
{
        ...
        try {
            ...
            std::vector<std::string> data(input.begin() + 1 , input.end());
            ...
            auto result = func_under_test(N_str, M_str, data);
